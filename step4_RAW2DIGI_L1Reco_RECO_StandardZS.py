...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
         'file:step2_RAW2DIGI_DIGI2RAW_Hybrid_StandardZS.root'
    ),
...
process.siStripClusters.DigiProducersList = cms.VInputTag(cms.InputTag("siStripDigis", "ZeroSuppressed"))


process.TFileService = cms.Service("TFileService",
        fileName=cms.string("Clusters_Tracks_StandardZS.root")
)
...
process.reconstructionHeavyIons.remove(process.siStripZeroSuppression)
...
from Configuration.Applications.ConfigBuilder import MassReplaceInputTag; MassReplaceInputTag(process, new="rawDataRepacker")
