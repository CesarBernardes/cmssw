...
class HIPixelTracksSlimmer : public edm::stream::EDProducer<> {
   public:
      explicit HIPixelTracksSlimmer(const edm::ParameterSet&);
      ~HIPixelTracksSlimmer();
...
//
HIPixelTracksSlimmer::HIPixelTracksSlimmer(const edm::ParameterSet& iConfig) : 
...
HIPixelTracksSlimmer::~HIPixelTracksSlimmer()
{
...
void
HIPixelTracksSlimmer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  using namespace std;
...
void
HIPixelTracksSlimmer::beginStream(edm::StreamID)
{
}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void
HIPixelTracksSlimmer::endStream() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
HIPixelTracksSlimmer::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
HIPixelTracksSlimmer::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
HIPixelTracksSlimmer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
HIPixelTracksSlimmer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/

void 
HIPixelTracksSlimmer::addPackedCandidate(std::vector<pat::PackedCandidate>& cands,
					    const reco::TrackRef& trk,
					    const reco::VertexRef& pvSlimmed,
					    const reco::VertexRefProd& pvSlimmedColl,
                                            bool passPixelTrackSel)const
...
void
HIPixelTracksSlimmer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  descriptions.add("HIPixelTracksSlimmer", desc);
}

//define this as a plug-in
DEFINE_FWK_MODULE(HIPixelTracksSlimmer);
