...
process.RAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_RAW2DIGI_DIGI2RAW_Hybrid_StandardZS.root'),
...
process.DigiToRaw2 = cms.Sequence(process.siStripZeroSuppression+process.siStripRepackZS+process.rawDataRepacker)
